...
const Blog = () => {
    return (
        <div className='blog-container'>
            ...
            <p>Ans: We use a props drill when we send data from the parent component to the child component and the grand child component.
            ...
            <p>Ans:Webpages were initially created using HTML or markup language. Now with the semantic tags in HTML5 many benefits are available and things can be done faster. There is accessibility for such blind users. There are search engine friendly technologies. If we use semantic tags when creating webpages, the browser can easily capture the content, which helps in layout and design. <br />
